...
export default function Atividades() {
    ...
    useEffect(() => {
        setOrdemAcoes([
            { id: 1, nome: 'Texto', duracao: duracaoTexto },
            { id: 2, nome: 'Imagem 1', duracao: duracao1 },
            { id: 3, nome: 'Imagem 2', duracao: duracao2 },
    ...
    }, [duracaoTexto, duracao1, duracao2, , duracaoTexto2, duracaoTexto3, duracaoTexto4, duracaoVideo, duracaoCronometro, duracaoMetronomo, duracaoFlashCard, duracaoAudio]);
    ...
    const renderAcaoAtual = () => {
        ...
        switch (acaoAtualObj.id) {
            ...
            case 7:
                return <div style={{ margin: '0', width: '100%', overflow: 'none', height: '100%' }}>
                    <Metronomo />
                </div>
            case 8:
                return <div style={{ display: 'flex', margin: 'auto' }}>
    ...
    return (
        <div className="container mt-5">
            ...
            <h2 style={{ textAlign: 'center', margin: '40px 0' }}>ADA NOVO</h2>
            <div id="main-container-add-itens">
                <div>
                    ...
                    {/* <a href="#" onClick={() => setContainerTexto(!containerTexto)}> */}
                    <a href="#" onClick={() => {
                        // clickText = + 1
                        document.querySelectorAll(".containerTexto")[clickText].style.display = "none";
                    }}>
                        <img src={iconTexto} />
                    </a>
                    <a href="#imagem" onClick={() => setContainerImagem(!containerImagem)}>
                        <img src={iconImage} />
                    </a>
                </div>
                <div>
                    <a href="#video" onClick={() => setContainerVideo(!containerVideo)}>
                        <img src={iconVideo} />
                    </a>
                    <a href="#cronometro" onClick={() => SetcontainerCronometro(!containerCronometro)}>
                        <img src={iconCronometro} />
                    </a>
                </div>
                <div>
                    <a href="#metronomo" onClick={() => setContainerMetronomo(!containerMetronomo)}>
                        <img src={iconMetronomo} />
                    </a>
                    <a href="#flashCard" onClick={() => setContainerFlashCard(!containerFlashCard)}>
                        <img src={iconFlashCard} />
                    </a>
                </div>
                <div>
            ...
            {/* SEÇÃO 01 */}
            <div>
                <div className="container mt-5 containerTexto" id="texto">
                    <div className="form-group" style={{ margin: '20px 0' }}>
                        <label htmlFor="texto"><h6 id="texto">1º Ação - Texto: </h6></label>
                        <textarea
                            id="texto"
                            value={texto}
                ...
                <div>
                    <div className="col-md-6" style={{ margin: '20px 0' }} className="containerImagemItem">
                        <h6 id="imagem">1º Ação - Imagem:</h6>
                        <div className="form-group">
                            <input
                                type="file"
                                accept="image/*"
            ...
            <div>
                <div className="container mt-5 containerTexto" id="texto">
                    <div className="form-group" style={{ margin: '20px 0' }}>
                        <label htmlFor="texto"><h6 id="texto">2º Ação - Texto: </h6></label>
                        <textarea
                            id="texto"
                            value={texto}
                            onChange={handleTextChange}
                ...
                <div>
                    <div className="row containerImagemItem" >
                        <div className="col-md" style={{ margin: '20px 0' }}>
                            <h6 id="imagem">2º Ação - Imagem:</h6>
                            <div className="form-group">
                                <input
                                    type="file"
                                    accept="image/*"
            ...
            <div>
                ...
                <div>
                    ...
                    <div className="container mt-5 containerTexto" id="texto">
                        <div className="form-group" style={{ margin: '20px 0' }}>
                            <label htmlFor="texto"><h6 id="texto">3º Ação - Texto: </h6></label>
                            <textarea
                                id="texto"
                                value={texto}
                                onChange={handleTextChange}
            ...
            <div className={`container mt-5 ${apresentando ? 'apresentando' : ''}`}>
                ...
                <div className="text-center mt-5 container-apresentacao" id="container-apresentacao">
                    {renderAcaoAtual()}
                </div>
            </div>
